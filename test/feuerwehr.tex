...
\setkomavar{myref}{Kreth}
%\setkomavar{yourmail}{21. Februar 2007}
\setkomavar{signature}{Markus Kreth}
\setkomavar{invoice}[Steuernr.]{25/124/04832}
\setkomavar{customer}[Hinweis:]{Kein gesonderter Ausweis der Umsatzsteuer \mbox{(§ 19 UStG)}
...
%}
\setkomavar{subject}{Rechnung für }
\begin{document}
\firstfoot{%
\parbox[b]{\linewidth}{%
...
für die folgenden von mir erbrachten Leistungen erlaube ich mir %%summe%%
 zu berechnen.

%%tabelle%%

Bitte überweisen Sie den Betrag bis zum %%zahlfrist%%
