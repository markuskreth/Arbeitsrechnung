...
public class RechnungDataTest {
   ...
   public void setUp() throws Exception {
      optionen = new Options.Build().dbHost("localhost").dbUser("markus").dbPassword("0773").dbDatabaseName("arbeitrechnungen").stdTexFile("Rechnung_Allgemein.tex")
   ...
   public void testMakePdf_buchholz_abrechnung() throws FileNotFoundException {
      ...
      Rechnung rech = new Rechnung.Builder().klienten_id(klienten_id).adresse(adresse).texdatei(tex_datei).einheiten(einheiten).datum(rechnungsdatum).zahldatum(zahlungsdatum)
            .rechnungnr(rechnungsnr).zusatz1Name(zusatz1_name).zusatz2Name(zusatz2_name).zusatz1(false).zusatz2(false).stunden(stunden)
            .zusammenfassungenErlauben(zusammenfassungen_erlauben).build();
   ...
   public void testMakePdf_Rechnung_Allgemein() throws FileNotFoundException {
      ...
      Rechnung rech = new Rechnung.Builder().klienten_id(klienten_id).adresse(adresse).texdatei(tex_datei).einheiten(einheiten).datum(rechnungsdatum).zahldatum(zahlungsdatum)
            .rechnungnr(rechnungsnr).zusatz1(false).zusatz2(false).stunden(stunden).zusammenfassungenErlauben(zusammenfassungen_erlauben).build();
   ...
   private void makeFakeEinheitenBuchholz(Vector<Arbeitsstunde> einheiten) {
      einheiten.add(new ArbeitsstundeImpl.Builder(1, 1, 1).datum(new Date(1386856800000L)).inhalt("Sport1").dauerInMinuten(120).einzelPreis(10.5).beginn(new Date(1386856800000L))
            .ende(new Date(1386856810000L)).zusatz1(String.valueOf(13)).preis(15.6).build());
      einheiten.add(new ArbeitsstundeImpl.Builder(2, 1, 1).datum(new Date(1386943200000L)).inhalt("Sport2").dauerInMinuten(180).einzelPreis(11.5).beginn(new Date(1386943200000L))
            .ende(new Date(1386943210000L)).zusatz1(String.valueOf(15)).preis(16.7).build());
      einheiten.add(new ArbeitsstundeImpl.Builder(3, 1, 1).datum(new Date(1387029600000L)).inhalt("Sport3").dauerInMinuten(90).einzelPreis(12.5).beginn(new Date(1387029600000L))
            .ende(new Date(1387029610000L)).zusatz1(String.valueOf(17)).preis(17.8).build());
      einheiten.add(new ArbeitsstundeImpl.Builder(3, 1, 2).datum(new Date(1387202400000L)).inhalt("Sport4").dauerInMinuten(45).einzelPreis(13.5).beginn(new Date(1387202400000L))
            .ende(new Date(1387202410000L)).zusatz1(String.valueOf(21)).preis(18.9).build());
   }
   ...
   public void testMakePdfEmpty() throws FileNotFoundException {
      ...
      Rechnung rech = new Rechnung.Builder().klienten_id(klienten_id).adresse(adresse).texdatei(tex_datei).einheiten(einheiten).datum(rechnungsdatum).zahldatum(zahlungsdatum)
            .rechnungnr(rechnungsnr).zusatz1(false).zusatz2(false).stunden(true).stunden(stunden).zusammenfassungenErlauben(zusammenfassungen_erlauben).build();
