...
\parbox{12cm}{\begin{large}\underline{\textbf{Abrechnung für Monat: Juni 2017}}\end{large}}\\
...
\end{tabular} 
\begin{flushright}
\parbox{5cm}{\textbf{Total STD.} 8,00}\end{flushright}
\hfill\hfill \textbf{Vergütung:} 8,00 Stunden x 15.00 EUR = 130,00 \officialeuro\  brutto EUR \hspace*{2cm}\\
\end{flushright}
\vfill
