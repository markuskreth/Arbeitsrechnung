...
\parbox{12cm}{\begin{large}\underline{\textbf{Abrechnung für Monat: September 2009}}\end{large}}\\
...
\end{center}
\vspace{9mm}
\includegraphics[width=3.5cm]{/home/markus/programming/NetBeansProjects/Arbeitsrechnungen/Tex-Vorlagen/Sign.jpg}
\begin{center}
