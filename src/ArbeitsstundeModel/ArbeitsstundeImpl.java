...
public class ArbeitsstundeImpl implements Arbeitsstunde
{
	 ...
	 *
	 * @param einzelPreis new value of einzelPreis
	 */
     ...
     *
     * @param dauer new value of dauer
     */
     ...
     *
     * @param preis new value of preis
     */
     ...
     *
     * @param inhalt new value of inhalt
     */
     ...
     *
     * @param Auftraggeber new value of Auftraggeber
     */
    ...
    public Vector<Object> toVector(){
        ...
        try{
            ...
            try{
                datensatz.add(
                        DateFormat.getDateInstance(java.text.DateFormat.MEDIUM, Locale.GERMAN).format(this.datum)
                        );
            } catch (Exception e){
            ...
            try{
                datensatz.add(
                        DateFormat.getDateInstance().format(this.verschickt)
                        );
            } catch (Exception e) {
