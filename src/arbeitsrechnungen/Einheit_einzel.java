...
//        System.out.println("indexOF: " + this.angeboteliste.elementAt(this.jComboBoxAngebot.getSelectedIndex()));
    ...
    private void initComponents() {
        ...
        jComboBoxAngebot = new javax.swing.JComboBox();
        ...
        jComboBoxAngebot.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Doppelstunde Untericht + Computer|24€", "Item 2" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Einheit_einzel().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox jComboBoxAngebot;
