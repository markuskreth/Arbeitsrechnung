...
public class Arbeitsstunden extends JFrame {
	 ...
	 * @param optionen
	 */
	public Arbeitsstunden(Properties optionen) {
		ready = false;
	...
	private void initComponents() {
		...
		jComboBoxKunden.setModel(new DefaultComboBoxModel<String>(
				auftraggeberliste));
	...
	private void jComboBoxKundenItemStateChanged(java.awt.event.ItemEvent evt) {
		if (ready){
