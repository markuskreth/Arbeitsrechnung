 ...
 * @author markus
 */
public class KlientenEditorJFrame extends javax.swing.JFrame {

	private static final long serialVersionUID = 841146928928449190L;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(arbeitsrechnungen.ArbeitsrechnungenApp.class).getContext().getResourceMap(KlientenEditorJFrame.class);
        ...
        jTableAngebote.setModel(new javax.swing.table.DefaultTableModel(
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1709284540766518646L;
    ...
    private void updateAngeboteTabelle() {
        ...
        javax.swing.table.DefaultTableModel mymodel = new javax.swing.table.DefaultTableModel(
            ...
            /**
					 * 
					 */
					private static final long serialVersionUID = -6000123005720215518L;
...
//        System.out.println("Event.getSource: " +  event.getSource());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                KlientenEditorJFrame dialog = new KlientenEditorJFrame();
