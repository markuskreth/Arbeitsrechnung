...
public class KlientenEditor extends JDialog {
    ...
    private void initComponents() {
        ...
        arbeitsstundenTabelle1 = new ArbeitsstundenTabelle(this, currentKlient.getKlienten_id());
        jPanelRechnungen = new JPanel();
        formRechnungen1 = new FormRechnungen(getOwner(), currentKlient.getKlienten_id());
    ...
    private void updateAngeboteTabelle() {
        ...
        angebote = persister.getAngeboteForKlient(klient);
    ...
    private void jButtonDeleteAngebotActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteAngebotActionPerformed
        if (this.jTableAngebote.getSelectedRow() == -1) {
            ...
            try {
                ...
                int ergebnis = JOptionPane.showConfirmDialog(this, "Soll der Datensatz " + angebot.getInhalt() +
