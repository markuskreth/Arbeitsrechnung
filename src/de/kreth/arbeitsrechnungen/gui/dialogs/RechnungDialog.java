...
import de.kreth.arbeitsrechnungen.PdfCreator;
...
public class RechnungDialog extends JDialog implements PropertyChangeListener, DocumentListener {
	...
	private RechnungDialog(Options optionen, Window parent) {
		...
		initComponents();
		klientenPersister = (KlientenEditorPersister) ArbeitRechnungFactory.getInstance()
				.getPersister(KlientenEditorPersister.class, optionen);
		persister = (RechnungDialogPersister) ArbeitRechnungFactory.getInstance()
				.getPersister(RechnungDialogPersister.class, optionen);

		heute = new GregorianCalendar();
	}

	/**
	 * Erstellt einen neuen RechnungsDialog für die übergebene RechnungsId. Die alte
	...
	public RechnungDialog(Options optionen, Window parent, Vector<Integer> einheiten) {
		...
		Builder reBuilder = new Rechnung.Builder().texdatei(optionen.getStdTexFile()).datum(heute).zahldatum(zahldatum)
				.einheiten(this.einheiten).rechnungnr(generateRechnungsnr(heute))
				.klienten_id(this.klient.getKlienten_id()).zusatz1(klient.hasZusatz1()).zusatz2(klient.hasZusatz2())
	...
	private void changeText(DocumentEvent e) {
		if (logger.isDebugEnabled()) {
			logger.debug(e.getDocument().getProperty("name").toString() + " wurde geändert! DefaultRootElement: "
	...
	private void initComponents() {
		...
		jToggleButtonZusammenfassungen
				.setToolTipText(resourceMap.getString("jToggleButtonZusammenfassungen.toolTipText")); // NOI18N
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup()
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(jLabel6)
								.addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
										.addComponent(jTextTexDatei, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
								...
								.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
										...
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabel7)))
						.addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel6)
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(jTextTexDatei, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(jButton3, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jCheckBoxVorschau)
						.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(jToggleButtonZusammenfassungen).addComponent(jLabel7))
		...
		jPaneluntenLayout.setHorizontalGroup(jPaneluntenLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 570, Short.MAX_VALUE));
		jPaneluntenLayout.setVerticalGroup(
				jPaneluntenLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(jTabbedPane1,
						GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE));
		...
		jPanelobenLayout.setHorizontalGroup(jPanelobenLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanelobenLayout.createSequentialGroup().addGroup(jPanelobenLayout
						.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(jPanelobenLayout.createSequentialGroup().addComponent(jCheckBoxZusatz1)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(jCheckBoxZusatz2)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						...
						.addGroup(GroupLayout.Alignment.TRAILING,
								jPanelobenLayout.createSequentialGroup()
										.addGroup(jPanelobenLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addGroup(jPanelobenLayout.createSequentialGroup().addContainerGap()
														.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 425,
																Short.MAX_VALUE))
												.addGroup(jPanelobenLayout.createSequentialGroup()
														.addComponent(jToggleButtonDetails, GroupLayout.PREFERRED_SIZE,
																31, GroupLayout.PREFERRED_SIZE)
														.addGap(241, 241, 241)))
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(jPanelobenLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
												.addGroup(jPanelobenLayout
														.createParallelGroup(GroupLayout.Alignment.TRAILING)
														.addComponent(jLabel3, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
														.addComponent(jLabel5, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
														.addComponent(jDateZahlDatum, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
														.addComponent(jLabel4, GroupLayout.Alignment.LEADING,
																GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(jTextRechnungsnummer, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
												.addComponent(jDateRechnungsdatum, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addGroup(jPanelobenLayout.createSequentialGroup().addContainerGap().addComponent(jLabel2)))
						.addContainerGap()));
		jPanelobenLayout
				.setVerticalGroup(jPanelobenLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(jPanelobenLayout.createSequentialGroup().addContainerGap().addComponent(jLabel2)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanelobenLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addGroup(jPanelobenLayout.createSequentialGroup()
												...
												.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(
														jTextRechnungsnummer, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addContainerGap())
										.addGroup(jPanelobenLayout.createSequentialGroup()
												.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 229,
														Short.MAX_VALUE)
												.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
												.addGroup(jPanelobenLayout
														.createParallelGroup(GroupLayout.Alignment.BASELINE)
														.addComponent(jCheckBoxZusatz1).addComponent(jCheckBoxZusatz2)
														.addComponent(jCheckBoxStundenzahl)
														.addComponent(jCheckBoxUnterschrift))
												.addGap(18, 18, 18).addComponent(jToggleButtonDetails,
		...
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
								.addComponent(jSplitPane1, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 572,
										Short.MAX_VALUE)
								.addGroup(GroupLayout.Alignment.LEADING,
										layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(jLabel1)
												.addGroup(GroupLayout.Alignment.TRAILING,
														layout.createSequentialGroup().addComponent(jButtonErstellen)
																.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				...
				layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(
								layout.createSequentialGroup().addContainerGap().addComponent(jLabel1)
										.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jSplitPane1, GroupLayout.DEFAULT_SIZE, 542, Short.MAX_VALUE)
										.addGap(18, 18, 18)
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
												.addComponent(jButton1).addComponent(jButtonErstellen))
										.addContainerGap()));
			...
			if (tmp.getName().matches("jDateRechnungsdatum")) {
				...
				if (!this.useCreateinsteadUpdate)
					JOptionPane.showMessageDialog(this,
							"Die Rechnungsnummer wurde auf den Standard-Wert zurückgesetzt!", "Achtung!",
	...
	private void jButtonErstellenActionPerformed(ActionEvent evt) {
		...
		try {
			...
			if (pdf_ergebnis == 0) {
				if (JOptionPane.showConfirmDialog(null, "Soll diese Rechnung so gespeichert werden?", "Speichern?",
			...
			String message = "Datei " + rechnung.getTexdatei() + "\nkonnte nicht gefunden werden!\nAbbruch!";
			logger.error(message, e);
			JOptionPane.showMessageDialog(this, message, "Datei nicht gefunden", JOptionPane.ERROR_MESSAGE);
		}
