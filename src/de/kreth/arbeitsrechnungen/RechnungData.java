...
public class RechnungData {
	...
	Vector<Arbeitsstunde> einheiten;
	/**
	...
	public boolean initRechnung(int klienten_id, String adresse,
			...
			Calendar heute, Calendar rechnungsdatum,
	...
	public int makePdf() {
		...
		if (std_ersetzung) {
			...
			String new_monat = einheit_dat.getDisplayName(Calendar.MONTH,
					Calendar.LONG, Locale.GERMANY)
					+ " "
					+ einheit_dat.get(Calendar.YEAR);
	...
	private String createTable() {
		...
		if (std_ersetzung) {
			...
			if (this.stunden)
				tabelle.append(" & Std.");
			if (this.zusatz1_name != null)
				tabelle.append(" & " + this.zusatz1_name);
			if (this.zusatz2_name != null)
				tabelle.append(" & " + this.zusatz2_name);
			...
			case 0: // Datum, Inhalt, Preis
				tabelle.append(TEXLINE + "& & " + zf.format(summe) + " " + TEXEURO
						+ TEXUMBRUCH + TEXLINE + "\n" + "\\\\end{tabular}");
				break;
			...
			case 2: // Datum, Inhalt, Ein Zusatz, Honorar
				tabelle.append(TEXLINE + "& & & " + zf.format(summe) + " "
						+ TEXEURO + TEXUMBRUCH + TEXLINE + "\n"
						+ "\\\\end{tabular}");
				break;
